...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/flat-meadow-3cee
```

A live public deployment of this template is available at [https://flat-meadow-3cee.templates.workers.dev](https://flat-meadow-3cee.templates.workers.dev)
